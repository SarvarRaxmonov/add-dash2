...
class Student(models.Model):
    ...
    email = models.EmailField()
    address = models.CharField(max_length=150)
    group = models.ForeignKey(Groupv, on_delete=SET_NULL, blank=True, null=True)
...
class Post(models.Model):
    ...
    photo = models.ImageField(upload_to='media/post', null=True, blank=True)
